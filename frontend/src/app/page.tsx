  ...
  useEffect(() => {
    fetchFriends()
      .then((f) => {
        ...
        setMessages([
          mkMsg("assistant",
            "Hello! I'm your MeetBite assistant. I can help you find the perfect restaurant for your group.\n\n" +
        ...
        <div className="max-w-[1800px] mx-auto px-6 py-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <img src="/meetbite-logo.svg" alt="MeetBite" className="h-10" />
            </div>
          ...
          <div className="grid grid-cols-5 gap-6" style={{ height: "calc(100vh - 140px)" }}>
            ...
            <div className="col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
              ...
              <div className="px-6 py-4 border-b border-gray-200 shrink-0">
                <div className="flex items-center gap-3">
                  <img src="/meetbite-icon.svg" alt="MeetBite" className="h-9 w-9 rounded-lg" />
                  <div>
                    <h2 className="font-semibold text-gray-900">MeetBite Assistant</h2>
                    <p className="text-xs text-gray-500">Find the perfect restaurant for your group</p>
                  </div>
                </div>
              </div>
